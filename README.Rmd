...
For Meliponini (Apidae), Euglossini (Apidae) and Augochlorini (Halictidae) the function uses genus- or tribe-specific equations. For all other bees the function uses the function ITtongue from the BeeIT package to estimate the proboscis length.
